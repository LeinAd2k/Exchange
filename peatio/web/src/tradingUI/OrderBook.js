...
class OrderBook extends React.Component {
  ...
  centerSpread() {
    this.scroller.scrollTop =
      (this.scroller.scrollHeight - this.scroller.clientHeight) / 2;
  }
  ...
  render() {
    ...
    const spread = this.state.hasOrders
      ? getPrice(visibleAsks.last()) - getPrice(visibleBids.first())
      : undefined;
    const dataConfigs = [
      {
        propName: "size",
      ...
      <TradingUIParent {...safeProps}>
        ...
        <TradingUIContentWrapper>
          <TradingUIStickyContent>
            ...
            <TradingUITableHead>
              {showSizeBar ? (
                <TradingUITableHeading style={{ width: sizeBarMaxWidth }} />
              ) : null}

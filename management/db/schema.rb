...
ActiveRecord::Schema.define(version: 2019_08_24_142252) do
  ...
  create_table "currencies", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", comment: "币种", force: :cascade do |t|
  ...
  create_table "funds", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", comment: "商品", force: :cascade do |t|
